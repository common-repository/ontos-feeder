...
/*
 Plugin Name: Ontos Feeder
 Plugin URI:
 Description: Provides information semantically relevant to the content being edited.
 Version: 1.0
 Author: Ontos AG
 Author URI: http://www.ontos.com
 */

require_once 'ota_constants.php';
require_once 'ota_options.php';
require_once 'ota_wizard.php';
require_once 'ota_styles.php';
require_once 'ota_gettagsbutton.php';
require_once 'ota_highlighting.php';
?>
